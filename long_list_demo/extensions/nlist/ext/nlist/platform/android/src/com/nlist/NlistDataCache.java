...
public class NlistDataCache  {
	...
	public NlistData getData(int index) {
		...
		if (data == null) {
			try {
				...
				com.rhomobile.rhodes.util.Utils.platformLog("NLIST", "$$$$$$$$$   NListData.getData() exception");
				e.printStackTrace();
			}
		}
	...
	public void executeHttpGet(int index, int count) throws Exception {
		...
		// hack for allow sync request to our local server
		// TODO: refactor code to use asynchronously requests !
